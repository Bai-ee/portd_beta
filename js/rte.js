  ...
  var f = "beforeend",
    ...
    r = function (e, t) {
      ...
      return (
        ...
        e.bold !== v &&
          l.insertAdjacentElement(f, s("bold", "Bold", u("fas fa-bold"), t)),
        e.italic !== v &&
          l.insertAdjacentElement(
            f,
        ...
        e.justifyleft !== v &&
          l.insertAdjacentElement(
            f,
            s("justifyleft", "Left align", u("fas fa-align-left"), t)
          ),
        e.justifycenter !== v &&
          l.insertAdjacentElement(
            f,
            s("justifycenter", "Center align", u("fas fa-align-center"), t)
          ),
        e.justifyright !== v &&
          l.insertAdjacentElement(
            f,
            s("justifyright", "Right align", u("fas fa-align-right"), t)
          ),
        l.insertAdjacentElement(f, p()),
        e.insertorderedlist !== v &&
          l.insertAdjacentElement(
            f,
            s("insertorderedlist", "Numbered list", u("fas fa-list-ol"), t)
          ),
        e.insertunorderedlist !== v &&
          l.insertAdjacentElement(
            f,
            s("insertunorderedlist", "Bulleted list", u("fas fa-list-ul"), t)
          ),
        e.outdent !== v &&
          l.insertAdjacentElement(
            f,
        ...
        e.removeFormat !== v &&
          l.insertAdjacentElement(
            f,
            s("removeFormat", "Clear formatting", u("fas fa-eraser"), t)
          ),
        l
      );
    },
